 ...
 * @author Juneau
 */
@WebServlet(name = "ReporterServlet", urlPatterns = {"/ReporterServlet"})
public class ReporterServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Job Report Invoker</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h2>This servlet initiates the job report task.  Please look "
                    + "in the server log to see the results.</h2> <br />" +
                    " This task is not run asynchronously, the task will process independently.");
            out.println("<br/><br/>");
            ReporterTask reporterTask = new ReporterTask("JobsReport");
